...
const vid2 = document.querySelector('#videos video:nth-child(2)');
...
new BPMvids('test-vid1', 'videos/test.mp4', 'mp4');
new BPMvids('test-vid2', 'videos/test.mp4', 'mp4');
...
new GenreVids('testGenre', 'testLink');
